...
API_ID = int(environ('API_ID','bb83a71c328abfa51f53d3d24756ee18'))
API_HASH = environ('API_HASH','7809215')
BOT_TOKEN = environ('BOT_TOKEN','5649086028:AAGZWzb35VoeXH4esUGv4XlMs8JBkHJxwjY')
...
IMDB_LINK = environ.get('IMDB_LINK', 'https://imdb.com/find?q={mv_rqst}')

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5726592912').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', 'o').split()]
...
FILE_FORWARD = environ.get('FILE_FORWARD',"-1001846865899")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', "-1001846865899"))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001846865899')).split()]
